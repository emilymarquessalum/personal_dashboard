...
import '../../generic_tools/notes/popups/add_note_mdi.dart';
      ...
      actions: [
        ...
        InkWell(
            onTap: () async {
              ...
              PageStructure anchoredStructure = await PageCataloguePopup(
                bloc:
              ...
              context.read<PageStructuresBloc>().add(
                  PageStructuresMoveTopEvent(
                      pageStructure: anchoredStructure
                  )
              );
